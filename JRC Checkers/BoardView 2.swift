    ...
    */
    ...
    func AIThinking(aiMoves: [Position]) -> Position {
        ...
        */
        ...
        let relPos = [
            "U3L3": Move(y: -3, x: -3), "U3L1": Move(y: -3, x: -1), "U3R1": Move(y: -3, x: 1), "U3R3": Move(y: -3, x: 3),
            "U2L2": Move(y: -2, x: -2), "U2": Move(y: -2, x: 0), "U2R2": Move(y: -2, x: 2),
            "U1L3": Move(y: -1, x: -3), "U1L1": Move(y: -1, x: -1), "U1R1": Move(y: -1, x: 1), "U1R3": Move(y: -1, x: 3),
            "L2": Move(y: 0, x: -2), "R2": Move(y: 0, x: 2),
            "D1L3": Move(y: 1, x: -3), "D1L1": Move(y: 1, x: -1), "D1R1": Move(y: 1, x: 1), "D1R3": Move(y: 1, x: 3),
            "D2L2": Move(y: 2, x: -2), "D2": Move(y: 2, x: 0), "D2R2": Move(y: 2, x: 2),
            "D3L3": Move(y: 3, x: -3), "D3L1": Move(y: 3, x: -1), "D3R1": Move(y: 3, x: 1), "D3R3": Move(y: 3, x: 3)
        ]
